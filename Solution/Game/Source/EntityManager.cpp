								...
								if (tileId - 1 == tileset->tileProperty[t].tileId)
								{
									...
									if (tileIdPrevX > 0)
										for (int tp = 0; tp < tileset->tileCount; tp++)
											...
											{
												propPrevX = tilesetPrevX->tileProperty[tp].properties.GetProperty("detectAssemble", 0);
												break;
											}
									if (tileIdPrevY > 0)
										for (int tp = 0; tp < tileset->tileCount; tp++)
											...
											{
												propPrevY = tilesetPrevY->tileProperty[tp].properties.GetProperty("detectAssemble", 0);
												break;
											}
									
									
									if (tileset->tileProperty[t].properties.GetProperty("detectAssemble", 0) == propPrevX)
									{
									...
									else if (tileset->tileProperty[t].properties.GetProperty("detectAssemble", 0) == propPrevY)
									{
										for (int a = 0; a < assembledList.Count(); a++)
										{
											bool done = false;
